...
const RippleButton: React.FC<RippleButtonProps> = ({
  ...
  rippleDuration = 600,
  hoverBaseColor = '#d97706', // Gold default for hair salon theme
  hoverRippleColor: customHoverRippleColor,
  hoverBorderEffectColor = '#d9770677',
  ...
  const determinedJsRippleColor = useMemo(() => {
    ...
    return 'var(--button-ripple-color, rgba(217, 119, 6, 0.15))';
  ...
  // Default variant
  const baseClasses = "relative border-none overflow-hidden isolate transition-all duration-200 cursor-pointer px-4 py-2 bg-amber-600 hover:bg-amber-700 text-white rounded-lg";
